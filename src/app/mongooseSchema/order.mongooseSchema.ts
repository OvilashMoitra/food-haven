...
const orderSchema = new Schema<IOrder>(
    {
        ...
        status: { type: String, enum: [OrderStatus.confirmed, OrderStatus.delivered, OrderStatus.delivered], default: OrderStatus.pending },
        price: { type: "number", required: [true, 'Total price is required'] },
